...
require_once 'MLAExcelProcessor.php';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['excel_file'])) {
    try {
        ...
        // Process the file
        $excelProcessor = new MLAExcelProcessor($pdo);
        ...
        if ($results['errors'] > 0) {
            ...
            $message = "Successfully imported {$results['success']} MLA records!";
            $messageType = 'success';
        }
...
if (isset($_GET['action']) && $_GET['action'] === 'download_template') {
    ...
    if ($templatePath && file_exists($templatePath)) {
        ...
        header('Content-Disposition: attachment; filename="MLA_Master_Template.csv"');
...
<head>
    ...
    <title>Upload MLA Data - Excel Import</title>
...
<body>
    <div class="container">
        ...
        <div class="template-section">
            ...
            <p>Download the Excel template to see the required format for uploading MLA data.</p>
            <p><strong>Required columns:</strong> mp_constituency_code, mla_constituency_code, mla_constituency_name</p>
        ...
        <?php if ($results): ?>
            <div class="results-section">
                ...
                <div style="margin-top: 20px;">
                    <a href="mla_index.php" class="btn btn-primary">View All MLA Records</a>
                </div>
            </div>
        <?php endif; ?>
    </div>
